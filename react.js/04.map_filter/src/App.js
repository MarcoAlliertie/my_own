...
function App() {
  ...
  //map()은 기존 배열의 내용을 새로운 배열로 생성하는 함수
  //map()은 배열 내 모든 요소를 순차적으로 접근해서 원하는 형태로 변환할 수 있다.
  ...
  return (
    <div>
      {/* map()함수를 이용해서 데이터를 HTML 요소가 함께 반복할 때
          HTML 요소 내 key 속성을 고유한 값으로 반드시 설정해 줘야 한다. 
          * index 활용은 권장하지 않음.
          */}
