...
http.createServer(async(req,res)=>{
    ...
    */
    ...
    const op = parseUrl.query.cal;
     let result;
    op === "plus" && (result = num1 + num2);
    op === "minus" && (result = num1 - num2);
    op === "multiply" && (result = num1 * num2);
    op === "divide" && (result = num1 / num2);

    // switch(parseUrl.query.cal){
    //     case 'plus' : result = num1+num2; break;
    //     case 'minus' : result = num1+num2; break;
    //     case 'multiply' : result = num1+num2; break;
    //     case 'divde' : result = num1+num2; break;
    // }
    let data = `
    <html>
        <body>
